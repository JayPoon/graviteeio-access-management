...
import {ApplicationSettingsComponent} from "./domain/applications/application/settings/settings.component";
  ...
  { path: 'domains/:domainId', component: DomainComponent,
    ...
    children: [
      ...
      { path: 'applications/:appId',
        ...
        children: [
          { path: '', redirectTo: 'settings', pathMatch: 'full' },
          { path: 'settings', component: ApplicationSettingsComponent, resolve: { domain: DomainResolver } },
